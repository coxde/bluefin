...
favorite-apps = ['com.fyralabs.Readymade.desktop', 'documentation.desktop', 'discourse.desktop', 'io.gitlab.librewolf-community', 'org.gnome.Nautilus.desktop', 'org.gnome.Software.desktop']
